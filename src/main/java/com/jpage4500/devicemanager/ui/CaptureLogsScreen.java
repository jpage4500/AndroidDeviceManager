 ...
 */
public class CaptureLogsScreen extends BaseScreen {
    private static final Logger log = LoggerFactory.getLogger(CaptureLogsScreen.class);
    ...
    public CaptureLogsScreen(DeviceScreen deviceScreen, Device device) {
